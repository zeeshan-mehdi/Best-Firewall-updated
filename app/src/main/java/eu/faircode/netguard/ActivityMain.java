...
import com.shaikhutech.netguard.*;
public class ActivityMain extends AppCompatActivity implements SharedPreferences.OnSharedPreferenceChangeListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        MobileAds.initialize(getApplicationContext(),"ca-app-pub-6385726521734545~1049877858");


        //ads
        mInterstitialAd = new InterstitialAd(this);

        mInterstitialAd.setAdUnitId("ca-app-pub-6385726521734545/8353652802");
    ...
    private static Intent getIntentPro(Context context) {
        if (Util.isPlayStoreInstall(context))
            ...
            intent.setData(Uri.parse("https://contact.shaikhutech.com/?product=netguardstandalone"));
            return intent;
        }
    }
